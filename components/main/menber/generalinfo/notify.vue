<template>
    <div id="shipper">
        <nav-bar :title="$t('common.Notify')">
            <router-link to="/notifyedit">{{$t('common.add')}}</router-link>
        </nav-bar>
        <form action="/">
            <van-search
                v-model="value"
                        ...
                        <div class="item-main">
                            ...
                            <div class="right-content">
                                <div class="top-t">
                                    ...
                                    <router-link :to="`/notifyedit?id=${item.id}`">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getDate(params){
                notify('queryPage',params).then(res=>{
                    this.params.pageNo++;
            ...
            deleteIds(ids){
                notify('deleteByIds',{ids}).then(res=>{
                    if(res.data.code==1){
