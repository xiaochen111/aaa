<template>
    <div id="shipper">
        <nav-bar :title="$t('common.shouhuoren')">
            <router-link to="/shipperedit">{{$t('common.add')}}</router-link>
        </nav-bar>
        <form action="/">
            <van-search
                v-model="value"
                        ...
                        <div class="item-main">
                            ...
                            <div class="right-content">
                                <div class="top-t">
                                    ...
                                    <router-link :to="`/shipperedit?id=${item.id}`">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getDate(params){
                shipper('queryPage',params).then(res=>{
                    this.params.pageNo++;
            ...
            deleteIds(ids){
                shipper('deleteByIds',{ids}).then(res=>{
                    if(res.data.code==1){
